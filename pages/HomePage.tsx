            ...
            <section className="pt-12 pb-8 text-center">
                <div className="flex items-center justify-center gap-3 sm:gap-4 px-4">
                    ...
                    <div>
                        ...
                        <p className="text-xl sm:text-2xl lg:text-3xl font-extrabold text-white text-center [text-shadow:1px_1px_2px_#cc6e00,-1px_-1px_2px_#cc6e00,1px_-1px_2px_#cc6e00,-1px_1px_2px_#cc6e00] mt-4">
